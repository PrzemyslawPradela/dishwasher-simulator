 ...
 * @modify date 2020-02-13 05:05:01
...
int main()
{
	...
	while (1)
	{
		...
		{
			progressbar(0.1, "Podgrzewanie wody");
			buf.mtype = 1;
		...
		{
			progressbar(0.003, "Podgrzewanie wody");
			buf.mtype = 1;
			strcpy(buf.mtext, "done1");
			if (msgsnd(msqid, &buf, strlen(buf.mtext) + 1, 0) == -1)
			{
		...
		{
			progressbar(0.009, "Podgrzewanie wody");
			buf.mtype = 1;
			strcpy(buf.mtext, "done1");
			if (msgsnd(msqid, &buf, strlen(buf.mtext) + 1, 0) == -1)
			{
		...
		{
			progressbar(0.001, "Podgrzewanie wody");
			buf.mtype = 1;
			strcpy(buf.mtext, "done1");
			if (msgsnd(msqid, &buf, strlen(buf.mtext) + 1, 0) == -1)
			{
		...
		{
			progressbar(0.008, "Podgrzewanie wody");
			buf.mtype = 1;
			strcpy(buf.mtext, "done1");
			if (msgsnd(msqid, &buf, strlen(buf.mtext) + 1, 0) == -1)
			{
		...
		{
			progressbar(0.0001, "Podgrzewanie wody");
			buf.mtype = 1;
			strcpy(buf.mtext, "done1");
			if (msgsnd(msqid, &buf, strlen(buf.mtext) + 1, 0) == -1)
			{
